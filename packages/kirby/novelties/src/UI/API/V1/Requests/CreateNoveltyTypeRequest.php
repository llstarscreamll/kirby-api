...
/**
 * Class CreateNoveltyTypeRequest.
 *
 * @author Johan Alvarez <llstarscreamll@hotmail.com>
 */
class CreateNoveltyTypeRequest extends FormRequest
{
    /**
    ...
    {
        return $this->user()->can('novelty-types.create');
    }
    ...
    {
        return [
            'code' => ['required', 'string', 'unique:novelty_types'],
