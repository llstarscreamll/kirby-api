...
use Kirby\Novelties\UI\API\V1\Controllers\ExportEmployeeResumeByNoveltyTypesController;
...
Route::prefix('api/v1')
    ...
    ->group(function ($route) {
        ...
        $route->get('novelties/export-resume-by-novelty-type', ExportEmployeeResumeByNoveltyTypesController::class);
