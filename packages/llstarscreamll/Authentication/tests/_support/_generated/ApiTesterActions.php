<?php  //[STAMP] 329677c9f27c25e5a1440b7b9ed2bad8
...
trait ApiTesterActions
{
     ...
     * @see \Authentication\Helper\Api::amLoggedAsUser()
     */
    public function amLoggedAsUser($attrs = null, $driver = null) {
        return $this->getScenario()->runStep(new \Codeception\Step\Condition('amLoggedAsUser', func_get_args()));
    }
     ...
     * @return App\Containers\User\Models\User
     * @see \Authentication\Helper\Api::loginUser()
     */
    public function loginUser($user, $driver = null) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('loginUser', func_get_args()));
    }
